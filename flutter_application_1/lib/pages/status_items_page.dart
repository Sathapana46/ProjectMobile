...
class StatusItemsPage extends StatefulWidget {
  final String status;

  StatusItemsPage({required this.status});

  @override
  _StatusItemsPageState createState() => _StatusItemsPageState();
}

class _StatusItemsPageState extends State<StatusItemsPage> {
  List<Item> items = [];
  bool loading = true;
  ...
  load() async {
    ...
    items = allItems.where((i) => i.status == widget.status).toList();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text("สถานะ ${widget.status}")),
